...
plt.grid(True)
plt.axis([-8, 8, -8, 8])
plt.quiver(newPosition[0], newPosition[1], rotationVector[0], rotationVector[1], angles='xy', scale_units='xy', color='b',scale=1)
plt.quiver(newPosition[0], newPosition[1], shiftVector[0], shiftVector[1], angles='xy', scale_units='xy', color='g',scale=1)
